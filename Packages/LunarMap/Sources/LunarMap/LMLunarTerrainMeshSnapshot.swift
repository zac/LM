...
public struct LMLunarTerrainMeshTile: Sendable {
    public let plan: LMTerrainTilePlan
...
public struct LMLunarTerrainMeshSnapshot: Sendable {
    /// Finest first. The owner selection matches the parent quad masks.
    public let tiles: [LMLunarTerrainMeshTile]
    ...
    public func sample(east: Double, north: Double, coarserThan spacing: Double = 0, normalizeNormal: Bool = true) -> LMLunarTerrainMeshTile.Sample? {
