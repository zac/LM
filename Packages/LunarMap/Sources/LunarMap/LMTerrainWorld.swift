...
public struct LMFullDescentMapper: Equatable {
    ...
    public static func sunLightOrientation(from angles: LMHorizonAngles) -> simd_quatf {
...
public enum LMTerrainPresentationGrade: String, CaseIterable, Identifiable, Sendable {
    case calibrated
    case photographic
...
public enum LMTerrainWorld {
    ...
    public nonisolated static func missionSunIlluminance(
    ...
    package nonisolated static func earthshineIlluminance(
    ...
    package static var exposureFloor: Float {
    ...
    public struct Assembly {
        ...
        public let sun: DirectionalLight
        ...
        package let earthshine: DirectionalLight
        public let manifest: LMTerrainManifest
    ...
    public nonisolated static func missionShadowDistance(altitudeMeters: Double?) -> Float {
    ...
    public nonisolated static func missionShadow(
    ...
    nonisolated static func prepareBaseBands(
        manifest: LMTerrainManifest, bundle: Bundle = LunarMap.resources
