...
public enum LMLunarTerrainTiming {
    ...
    public static func begin(_ phase: String) -> Interval {
    ...
    public static func memory(_ phase: String, metalBytes: Int = 0, resourceBytes: Int = 0) {
    ...
    public static func measure<T>(_ phase: String, _ operation: () throws -> T) rethrows -> T {
...
@MainActor
public final class LunarExplorerPerformanceProbe: NSObject {
    public static let shared = LunarExplorerPerformanceProbe()
