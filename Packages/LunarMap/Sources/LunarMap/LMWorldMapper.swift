...
public struct LMWorldMapper: Equatable, Sendable {
    var highAltitudeMeters: Double
    var highVisualMeters: Double
    var nearAltitudeMeters: Double
    var nearVisualMeters: Double
    public var pdiRangeMeters: Double
    public var stripLengthMeters: Double
    var padRadiusMeters: Double

    public static let tabletop = LMWorldMapper(
    ...
    public func stripBeadOffset(downrangeMeters: Double) -> SIMD3<Float> {
    ...
    public static func attitudeOrientation(from attitude: LMQuaternion) -> simd_quatf {
    ...
    public func pose(from state: LMVehicleStateSnapshot, program: Int? = nil) -> (position: SIMD3<Float>, orientation: simd_quatf) {
        _ = program
