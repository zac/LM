...
public struct LMResolvedTerrainSample: Equatable, Sendable {
...
public struct LMProgressiveTerrainSampler: Sendable {
...
public struct LMLunarGeologyModel: Equatable, Sendable {
    public static let modelID = "surveyor-degraded-microrelief-v3"
...
public struct LMTerrainTileID: Hashable, Sendable {
    public let level: Int
    public let eastIndex: Int
    public let northIndex: Int
}
...
public struct LMTerrainTileEdges: OptionSet, Hashable, Sendable {
    ...
    public static let west = Self(rawValue: 1 << 0)
    public static let east = Self(rawValue: 1 << 1)
    public static let south = Self(rawValue: 1 << 2)
    public static let north = Self(rawValue: 1 << 3)
    static let all: Self = [.west, .east, .south, .north]
}

public struct LMTerrainTilePlan: Equatable, Sendable {
    public let id: LMTerrainTileID
    public let centerEastMeters: Double
    public let centerNorthMeters: Double
    public let sizeMeters: Double
    public let sampleSpacingMeters: Double
    let containsProceduralSubresolution: Bool
    public let transitionEdges: LMTerrainTileEdges
...
public struct LMTerrainDetailPolicy: Equatable, Sendable {
    public var globalBands = false
    let approachAltitudeMeters: Double
    package let terminalAltitudeMeters: Double
    package let landingAltitudeMeters: Double
    ...
    public let landingSpacingMeters: Double
    ...
    public func finestSpacingMeters(altitudeMeters: Double) -> Double? {
    ...
    package func presentationBlend(
        sampleSpacingMeters: Double,
...
public struct LMProgressiveTerrainPlanner: Sendable {
    public static let globalLevels: [Level] = [
    ...
    public struct Level: Equatable, Sendable {
        ...
        @usableFromInline package init(tileSizeMeters: Double, sampleSpacingMeters: Double, radiusInTiles: Int) {
            self.tileSizeMeters = tileSizeMeters
            self.sampleSpacingMeters = sampleSpacingMeters
            self.radiusInTiles = radiusInTiles
        }
    }
    ...
    /// generated tiles.
    package func viewCorridorPlans(
        focusEastMeters: Double,
        focusNorthMeters: Double,
    ...
    package func mergedPlans(_ plans: [LMTerrainTilePlan]) -> [LMTerrainTilePlan] {
    ...
    public func rectangularPlansEnclosingChildren(_ plans: [LMTerrainTilePlan]) -> [LMTerrainTilePlan] {
...
public struct LMTerrainSurfaceSample: Equatable, Sendable {
    public let measuredElevationMeters: Float
    public let renderedElevationMeters: Float
    public let presentationElevationMeters: Float
    public let sampleSpacingMeters: Double?
    public let presentationBlend: Double
}
...
public struct LMProgressiveTerrainSurfaceSampler: Sendable {
    private static let spacingToleranceMeters = 1e-6
