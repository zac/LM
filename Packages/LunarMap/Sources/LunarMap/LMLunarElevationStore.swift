...
public actor LMLunarElevationStore {
    ...
    public typealias Fetch = @Sendable (LMTerrainManifest.Source) async throws -> Data
    ...
    public init(directory: URL, capacityBytes: Int = 128 * 1_024 * 1_024,
    ...
    package func prefetch(_ sources: [LMTerrainManifest.Source]) async throws {
    ...
    @usableFromInline nonisolated static func fetchPDS(_ source: LMTerrainManifest.Source) async throws -> Data {
        try validate(source)
