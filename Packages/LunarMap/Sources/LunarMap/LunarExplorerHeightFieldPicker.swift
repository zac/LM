...
package struct LunarExplorerHeightFieldPicker: Sendable {
    ...
    package var additionalHeightBytes: Int {
    ...
    package func raycast(origin: SIMD3<Float>, direction: SIMD3<Float>) -> SIMD3<Float>? {
