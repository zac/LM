...
public struct LMLunarAnchoredPlacement {
    package let sourceTransform: Transform
    public let viewTransform: Transform

    package static func chunkTransform(origin: LMSiteENUPosition, source: LMSelenographicLocalFrame,
    ...
    public init(source: LMSelenographicLocalFrame, anchor: LMSelenographicLocalFrame,
