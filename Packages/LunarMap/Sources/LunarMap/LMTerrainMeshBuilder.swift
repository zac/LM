...
package enum LMTerrainMeshBuilder {
    ...
    package struct VertexData: Sendable {
    ...
    package static func mesh(from data: VertexData) throws -> MeshResource {
    ...
    package nonisolated static func meshAsync(from data: VertexData) async throws -> MeshResource {
    ...
    /// contact surface.
    package static func excludingProgressiveFootprints(
