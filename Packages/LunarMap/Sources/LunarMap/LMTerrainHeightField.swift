...
public protocol LMTerrainHeightField: Sendable {
...
extension LMTerrainHeightField {
    public var resolvesProceduralSamples: Bool { false }
    public func renderedParent(eastMeters: Double, northMeters: Double,
                        spacingMeters: Double) -> LMLunarTerrainMeshTile.Sample? { nil }
    public func resolvedSample(eastMeters: Double, northMeters: Double,
                        requestedSpacingMeters: Double) -> LMResolvedTerrainSample? { nil }
    public func prepared(eastMetersRange: ClosedRange<Double>,
