...
@MainActor
package final class LMLunarGlobeImagery {
    private weak var entity: ModelEntity?
    package var realizationAllowed: (@MainActor () -> Bool)?
    ...
    private let logger = Logger(subsystem: LunarMapLog.subsystem, category: "LunarImagery")
    ...
    package func update(width: Double, coordinate: LMSelenographicCoordinate, offline: Bool) {
    ...
    package func setRadiance(_ value: Double) {
        multiplier = value
