...
@MainActor
@Observable
public final class LunarExplorerSession {
    public init() {}
    ...
    public static func presentsControls(arguments: [String]) -> Bool {
    ...
    public var isExplorerExperience = false
    var isBrowsingGlobe = false
    public var immersionStyle: any ImmersionStyle = .full
    ...
    public var usesBundledSite = true
    ...
    public var currentCoordinate: LMSelenographicCoordinate?
