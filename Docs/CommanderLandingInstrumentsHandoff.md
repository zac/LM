...
Final acceptance: source `5ec10b8` passes all 64 selected regression tests in one native run. See `Validation/CommanderInstruments/README.md` for startup comparison, eight final views, test summary and exact source hashes.
