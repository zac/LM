...
struct LMLunarElevationCatalog: Decodable, Sendable {
    ...
    static func load(bundle: Bundle = .main) throws -> Self {
        ...
        guard let resource = manifest.remoteElevationCatalog,
              let location = bundle.url(forResource: resource.file, withExtension: nil) else {
        ...
        guard catalog.schemaVersion == 1, catalog.productID == "LDEM_128",
              ...
              let labelURL = bundle.url(forResource: catalog.labelFile, withExtension: nil),
