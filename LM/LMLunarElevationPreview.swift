...
enum LMLunarElevationPreview {
    ...
    static func load(coordinate: LMSelenographicCoordinate, offline: Bool,
                     manifest: LMTerrainManifest, bundle: Bundle = .main) async throws -> Assembly {
        ...
        guard let base, let baseFile = base.bundledFile,
              let baseURL = bundle.url(forResource: baseFile, withExtension: nil),
              let labelFile = base.bundledLabelFile,
              let labelURL = bundle.url(forResource: labelFile, withExtension: nil),
