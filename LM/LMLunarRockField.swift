...
struct LMLunarRockFieldModel: Equatable, Sendable {
    static let modelID = "apollo11-source-constrained-rock-field-v1"
    ...
    init(seed: UInt64 = 0x41_31_31_52_4F_43_4B) {
        self.seed = seed
    }
